...
{
	int nListSelectd = m_List.GetSelectionMark();
	CString strFile = m_List.GetItemText(nListSelectd, 0);
...
void CRemoteClientDlg::LoadFileCurrent()
{
	...
	while (pInfo->HasNext)
	{
		...
		if (pInfo->IsDirectory)
		{
			...
			HTREEITEM hTemp = m_Tree.InsertItem(pInfo->szFileName, hTree, TVI_LAST);
